...
future = now + 5  #### here is second of time which taken by emotion recognition system ,you can change it
    ...
    if time.time() > future: ##after 20second music will play
        try:
            ...
            if text == 'Angry':
                ...
                file = ('C:/Users/sumuk/Desktop/Capstone Project/final2/songs/Angry/' + randomfile)
                os.startfile(file)

            if text == 'Happy':
                randomfile = random.choice(os.listdir("./songs/Happy/"))
                print('You are smiling :) ,I playing special song for you: ' + randomfile)
                file = ('C:/Users/sumuk/Desktop/Capstone Project/final2/songs/Happy/' + randomfile)
                os.startfile(file)

            if text == 'Neutral':
                randomfile = random.choice(os.listdir("./songs/Neutral/"))
                print('You are Neutral of something ,I playing song for you: ' + randomfile)
                file = ('C:/Users/sumuk/Desktop/Capstone Project/final2/songs/Neutral/' + randomfile)
                os.startfile(file)

            if text == 'Sad':
                randomfile = random.choice(os.listdir("./songs/Sad/"))
                print('You are sad,dont worry:) ,I playing song for you: ' + randomfile)
                file = ('C:/Users/sumuk/Desktop/Capstone Project/final2/songs/Sad/' + randomfile)
                os.startfile(file)
            break
